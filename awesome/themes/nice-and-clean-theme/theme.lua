...
theme = {}
theme.theme_dir = "/home/drobati/.config/awesome/themes/nice-and-clean-theme"
theme.wallpaper_cmd = { "feh --bg-scale /home/drobati/Pictures/background.jpg" }
--theme.wallpaper_cmd = { "awsetbg /home/drobati/Pictures/background.jpg" }

theme.font          = "sans 10"

theme.bg_normal     = "#101010"
theme.bg_focus      = "#141314"
theme.bg_urgent     = "#141314"
theme.bg_minimize   = "#222222"

theme.fg_normal     = "#999993"
theme.fg_focus      = "#D02E54"
theme.fg_urgent     = "#70473a"
theme.fg_minimize   = "#eeeeee"

theme.border_width  = "1"
theme.border_normal = "#D02E54"
theme.border_focus  = "#D02E54"
theme.border_marked = "#D02E54"
